...
ARG TARGETARCH
ARG PROXMOX_K3S_VERSION=v1.0.11
ARG LOAD_GEN_REF=v0.1.9
ARG SCHEDULER_PLUGINS_REF=sophos-v0.2.12
ARG DESCHEDULER_REF=sophos-v0.0.4
ARG CHAOS_INJECTOR_REF=v0.1.1
